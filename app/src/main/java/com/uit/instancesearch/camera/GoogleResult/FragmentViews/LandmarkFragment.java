...
import com.uit.instancesearch.camera.GoogleModels.LandmarkItem;
...
public class LandmarkFragment extends Fragment {
    ...
    public static class LandmarkItemFragment extends Fragment {
        ...
        private void openGoogleMap(double latitude, double longitude, String locationName) {
            GoogleResultActivity.onLandmarkClickOpenGoogleMap(getActivity(),latitude, longitude, locationName);
        }
    }
