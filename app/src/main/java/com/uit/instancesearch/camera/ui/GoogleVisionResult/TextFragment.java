...
import com.uit.instancesearch.camera.ProcessingServer.GoogleImageAnnotationObject.TextItem;
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ((GoogleVisionResultActivity)getActivity()).onHighlight(TextFragment.class, index);
                }
            });
